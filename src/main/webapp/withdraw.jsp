        ...
        <%
                ...
                if (withdrawAmountStr != null && !withdrawAmountStr.isEmpty()) {
                    try {
                        ...
                        if (withdrawAmount <= 0 || withdrawAmount > Integer.parseInt(balance)) {
                            isValidAmount = false;
                        }
                ...
                // 유효한 금액일 경우 출금 처리
                if (isValidAmount) {
                    int newBalance = Integer.parseInt(balance) - withdrawAmount;
                    ...
                    transactions += "출금: " + withdrawAmount + "원 - 잔액: " + newBalance + "원;";
                    session.setAttribute("transactions", transactions);

                    out.println("<p>출금이 완료되었습니다.</p>");
                } else {
        %>
            <!-- 유효하지 않은 출금 액수를 입력받는 폼 -->
